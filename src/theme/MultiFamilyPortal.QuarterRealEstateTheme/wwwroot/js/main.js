    ...
    jQuery(document).ready(function(){
        ...
        */
        ...
        $('.ltn__shop-details-small-img').slick({
            ...
            arrows: true,
            focusOnSelect: true,
            prevArrow: '<a class="slick-prev"><i class="fa-solid fa-arrow-left" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next"><i class="fa-solid fa-arrow-right" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 992,
                    settings: {
